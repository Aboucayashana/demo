...
public class ProjetVin {
    ...
    public static void main(String[] args) {
        ...
        Vin vin5 = new Vin ("Bourgonne Côte de Beaune", 2002, chardonnay, blanc, 39.5);
        Vin vin6 = new Vin ("Aligoté", 2016, chardonnay, blanc, 7.12);
        Vin vin7 = new Vin ("Bourgonne Côte de Nuits", 2000, chardonnay, rose, 11.67);
        ...
        Vin vin20 = new Vin ("Château Suduiraur", 2007, sauvignon, rouge, 8.63);
        ...
        Bouteille b15 = new Bouteille (15,4, vin15); 
        ...
        do
        {
        System.out.println("Veuillez sélectionner un exercice:");
        System.out.println("1: Afficher les infos");
        System.out.println("2: Valeur de la cave ");
        System.out.println("3: Pourcentage de bouteille par couleur");
        ...
        case 1:
            System.out.println("");
            System.out.println("Liste de nos bouteilles");
            for (Bouteille b : mesBouteilles) 
            {
                System.out.println("");
                System.out.println("----------------------------------------------------------------------------------");
                System.out.println("ID = " + b.getIdBouteille());
                System.out.println("Quantite = " + b.getQuantiteBouteille());
                System.out.println("Vin = " + b.getLeVin().getNomVin() + "Millesime : " + b.getLeVin().getMillesimeVin() + " Prix :" + b.getLeVin().getPrixDuVin());
                System.out.println("Cepage = " + b.getLeVin().getLeCepage().getNomCepage());
                System.out.println("Couleur = " + b.getLeVin().getLacouleur().getNomCouleur());
            }
        break;
        
        case 2: double valeurCave = 0;
             for (Bouteille b : mesBouteilles) 
            {
                valeurCave += b.getQuantiteBouteille()*b.getLeVin().getPrixDuVin();
            }
             System.out.println("Valeur de la cave = " + valeurCave + "euros");
        break;
        
        case 3:
            for (Bouteille b : mesBouteilles) 
            {
                if(b.getLeVin().getLacouleur()==blanc)
                {nbBlanc ++; }
                else if (b.getLeVin().getLacouleur()== rose) 
                { nbRose ++; }
                else if (b.getLeVin().getLacouleur()== rouge) 
                { nbRouge ++;}
                i++;
            }
            System.out.println("");
            System.out.println("Pourcentage de vins rouges = " + nbRouge*100 + " % ");
            System.out.println("Pourcentage de vins roses = " + nbRose*100 + " % ");
            System.out.println("Pourcentage de vins blancs = " + nbBlanc*100 + " % ");
